...
#hor_pass(samples = example_img+1, example = example_img)
...
print("complete in time", toc-tic)
...
def logreg_hpass_only():
    ...
    # penalty = 'l1' --> lasso regularization
    # we need a solver that supports l1 penalty, saga also handles multinomial loss --> solver = 'saga'
    logreg_hpass = sklearn.linear_model.LogisticRegressionCV(cv = 10, penalty='l1', solver='saga').fit(hpass_matrix,labels)
...
#[TODO] implement this feature in the correct format
